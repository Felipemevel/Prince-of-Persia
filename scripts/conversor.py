...
INPUT_IMAGE = "bossfight.png" #colocar o nome do arquivo .png que sera convertido
OUTPUT_FILE = "stage1_bossfight.asm" #colocar o nome do arquivo .asm que sera gerado

BASE_LABEL = "cenario_2" # configurar corretamenteo o valor do rotulo que estara configurado no asm gerado
